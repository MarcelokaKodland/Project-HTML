...
@app.route("/")
def home():
    return '<h1>Selamat datang di web untuk melihat fakta menarik dan membuat password!!!</h1><a href="/random_fact">View a random fact!</a>\n<a href="/make_pass">Make a pass here!</a>'
...
def make_pass():
    ...
    return f'<p>Kami telah membuatkan password baru untukmu : {password}</p>'
